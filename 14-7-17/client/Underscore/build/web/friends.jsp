...
<html>
    ...
    <body>
        ...
        <p><strong>Pending Friend Requests</strong></p>
        <%
        ...
        <%
            PreparedStatement ps2 = conn.prepareStatement("SELECT * FROM friends JOIN users ON users.idno=friends.f2 WHERE (f1=? AND users.status=?) ORDER BY f2");
            ...
            if(rs2.first()){
                do{
                    ...
                    <form action="Unfriend" method="POST">
                        <input type="hidden" name="idno" value="<%= rs2.getString("users.idno") %>">
