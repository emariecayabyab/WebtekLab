...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 11, 2017 at 06:17 AM
...
(2094567, 'cooper', 'pending', '2094567@slu.edu.ph', NULL, NULL, NULL, 'user', 'Willy Boy', 'Cooper'),
...
--
ALTER TABLE `posts`
  MODIFY `postID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1012;
--
